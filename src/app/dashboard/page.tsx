      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 py-12">
        ...
        {activeOrder && (
          <Link href={`/orders/${activeOrder.id}`}>
            <div className="mb-6 bg-orange-50 border border-orange-200 rounded-2xl p-4 flex items-center justify-between hover:bg-orange-100 transition">
              <div className="flex items-center gap-3">
                <span className="text-2xl animate-bounce">
                  {activeOrder.order_type === "ride" ? "🏍️" : "🛒"}
                </span>
                <div>
                  <p className="font-bold text-orange-700 text-sm">Active order</p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
          {[
            ...
            <Link key={a.label} href={a.href}>
              <div className="flex flex-col items-center justify-center gap-2 rounded-2xl bg-white border border-gray-100 shadow-sm p-5 hover:shadow-md hover:border-orange-200 transition cursor-pointer">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link href="/orders" className="text-sm font-medium text-orange-500 hover:underline">
              View all
            </Link>
          </div>
            ...
            <div className="flex flex-col divide-y divide-gray-50">
              {orders.map((order) => (
                <Link key={order.id} href={`/orders/${order.id}`}>
                  <div className="flex items-center justify-between py-3.5 hover:bg-gray-50 -mx-2 px-2 rounded-xl transition">
                    <div className="flex items-center gap-3">
