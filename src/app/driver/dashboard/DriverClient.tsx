...
import {
  ...
  LogOut, Home, User, UploadCloud, Star,
} from "lucide-react";
...
function HomeTab({
  driver, orders, locationStatus, actionLoading, pending, advanceStatus,
}: {
  driver: Driver;
  orders: Order[];
              ...
              {isRide ? (
                ...
                <>
                  <div className="flex items-start gap-2 text-sm">
                    ...
                    <div><p className="text-xs text-slate-500">Market</p><p className="text-slate-200">{order.market_name}</p></div>
                  </div>
